        ...
        >
          ...
          <div class="w-full md:w-1/2 space-y-6 flex flex-col justify-center" data-aos="fade-up" data-aos-delay="200">
            <div>
              ...
              >
                ADDRESS: 
                <a :href="hotel.mapUrl" target="_blank" rel="noopener noreferrer" class="underline underline-offset-4 decoration-gray-300 hover:text-black hover:decoration-black transition-all duration-300 inline-flex items-center gap-1">
                  {{ hotel.address }}
